        ...
        <Box bg={"#f3f3f3"} pt="30px" pb="30px">
            ...
            < Box w="97%" margin="20px auto" display="flex" gap="10px">
                <Box w={{ base: "0%", lg: "18%" }} display={"flex"} flexDir="column" gap="40px" >
                    <CategoriesComp />
                    <Button w="100%" bgColor={"#6AA121"} color="white" textTransform={"uppercase"} _hover={{ bgColor: "#6AA121", color: "white" }} onClick={() => handleReset(1, "", "", "", [0, 45000])} display={{base:'none',lg:'block'}}>Reset Filter</Button>
                    <Filters />
                </Box>
