...
const Filters = () => {
    ...
    return (
        <Box pr="15px" bgColor="#ffffff" borderRadius={"10px"} pb="20px" display={{ base: "none", lg: "block" }}>
            ...
            <Button w="90%" bgColor={"#6AA121"} ml="20px" mt="10px" color="white" textTransform={"uppercase"} _hover={{ bgColor: "#6AA121", color: "white" }} onClick={() => handleReset(1, "", "", "", [0, 45000])}>Reset Filter</Button>
