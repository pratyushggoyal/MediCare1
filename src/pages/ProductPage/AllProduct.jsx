                            ...
                            {prod.map((el) => {
                                ...
                                return <GridItem key={id} w="100%" p={'14px 16px 15px 16px'} border='solid 1px rgba(112,112,112,.38)' borderRadius={"8px"} position="relative">
                                    ...
                                    <Box overflow={"hidden"} h='30px' w="100%" mt="5px" >
                                        <Text as="span" color={"#6AA121"} fontSize="10px" borderRadius={"40px"} mr="4px" p='4px 10px' bgColor={"#f3f7fb"}>{category}</Text>
                                        <Text as="span" color={"#6AA121"} fontSize="10px" borderRadius={"40px"} mr="4px" p='4px 10px' w="max-content" bgColor={"#f3f7fb"}>{sub_category}</Text>
                                    </Box>
                                    ...
                                    <Button w="100%" bgColor={"#6AA121"} color="white" textTransform={"uppercase"} _hover={{ bgColor: "#6AA121", color: "white" }} onClick={() => {
                                        handleAdd(el)
                                    }} >Add to cart</Button>
                                </GridItem >
                            })}
