                        ...
                        <Box pb='20px'>
                            <Box m='70px 0 50px 0' display={'flex'} alignItems='center' justifyContent={'center'}>
                                <Box>
                                    ...
                                    <Center>
                                        <Button onClick={handleAddProducts} _hover='none' mt='20px' bg='#6AA121' h='46px' fontSize={'15px'} color='#fff' borderRadius={'3px'} w='70%'>ADD PRODUCTS</Button>
                                    </Center>
                                </Box>
                            </Box>
                            <Box mt='50px'>
                                                            ...
                                                            <Flex w='100%'>
                                                                <Box w='100%'>
                                                                    ...
                                                                    <Flex mt='20px'>
                                                                        ...
                                                                        <Button bg='#6AA121' color='#fff' borderRadius={'3px'} fontSize={'12px'} size='xs' _hover={'none'} letterSpacing={'1px'} onClick={() => AddToCartFromSave(el)}>ADD TO CART</Button>
                                                                    </Flex>
                                                                </Box>
                                                                <Box w='20%'>
                                ...
                                <Box bg='#fff' borderRadius={'7px'}>
                                    <Box p='15px'>
                                        ...
                                        <Flex mt='15px' justifyContent={'space-between'}>
                                            <Text fontSize={'13px'} color='#6AA121' fontWeight={'600'} letterSpacing='1px'>ADD MORE ITEMS</Text>
                                            <AddIcon cursor={'pointer'} onClick={handleAddMore} color="#6AA121" />
                                        </Flex>
                                    </Box>
                                </Box>
                                                            ...
                                                            <Box w='100%' >
                                                                <Box w='100%'>
                                                                    ...
                                                                    <Flex mt='20px'>
                                                                        ...
                                                                        <Button bg='#6AA121' color='#fff' borderRadius={'3px'} fontSize={'12px'} size='sm' _hover={'none'} letterSpacing={'1px'} onClick={() => AddToCartFromSave(el)}>ADD TO CART</Button>
                                                                    </Flex>
                                                                </Box>
                                ...
                                <Box p='10px' pb='20px' borderRadius={'5px'} bg='#fff' mb='15px'>
                                    ...
                                    <Box mt='30px' pos='relative'>
                                        <Box ref={promeRef} display='none'>
                                            <Text color='#6AA121' fontSize={'12px'} fontWeight='600'>PROMOCODE</Text>
                                            <Box>
